========================================================================
    ACTIVE TEMPLATE LIBRARY : EventSource Project Overview
========================================================================

AppWizard has created this EventSource project for you to use as the starting point for
...
_EventSource.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_EventSource.h)
        GUID definitions                                (_EventSource_i.c)
        A type library                                  (_EventSource.tlb)
        Marshaling code                                 (_EventSource_p.c and dlldata.c)
EventSource.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named EventSource.pch and a precompiled types file named StdAfx.obj.
...
EventSourceps.vcproj
	...
	dlldata.c, EventSource_i.c and EventSource_p.c which are required

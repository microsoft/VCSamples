...
#define HID_REFRESH                             0x103EA
#define HID_PROCESS_SLIDER_LEVEL                0x103EB
#define HID_MODULE_SLIDER_LEVEL                 0x103EC
#define HID_CATEGORY_SLIDER_LEVEL               0x103ED
#define HID_PROCESS_STATIC1                     0x103EE
#define HID_PROCESS_STATIC2                     0x103EF
#define HID_PROCESS_STATIC3                     0x103F0
#define HID_APPLY                               0x103F1
#define HID_MODULE_STATIC1                      0x103F2
#define HID_MODULE_STATIC2                      0x103F3
#define HID_MODULE_STATIC3                      0x103F4
#define HID_CATEGORY_STATIC1                    0x103F5
#define HID_CATEGORY_STATIC2                    0x103F6
#define HID_CATEGORY_STATIC3                    0x103F7
#define HID_CLOSE                               0x103FA
#define HID_TRACE_TREE                          0x103FB
#define HID_SAVE                                0x10404
#define HID_LOAD                                0x10405
#define HID_CATEGORY_EDIT_LEVEL                 0x10406
#define HID_CATEGORY_SPIN_LEVEL                 0x10407
#define HID_PROCESS_EDIT_LEVEL                  0x10408
#define HID_MODULE_EDIT_LEVEL                   0x10409
#define HID_PROCESS_CHECKBOX_ENABLED            0x1040C
#define HID_PROCESS_SPIN_LEVEL                  0x1040E
#define HID_MODULE_SPIN_LEVEL                   0x1040F
#define HID_PROCESS_GROUPBOX                    0x10410
#define HID_PROCESS_STATIC_TRACELEVEL           0x10411
#define HID_CATEGORY_GROUPBOX                   0x10412
#define HID_CATEGORY_STATIC_TRACELEVEL          0x10413
#define HID_MODULE_STATIC_TRACELEVEL            0x10414
#define HID_MODULE_GROUPBOX                     0x10415
#define HID_PROCESS_CHECKBOX_FILENAMEANDLINENO  0x1041A
#define HID_MODULE_RADIO_INHERIT                0x1041B
#define HID_MODULE_RADIO_ENABLED                0x1041C
#define HID_MODULE_RADIO_DISABLED               0x1041D
#define HID_PROCESS_CHECKBOX_FUNCANDCATNAMES    0x1041E
#define HID_CATEGORY_RADIO_INHERIT              0x10421
#define HID_CATEGORY_RADIO_ENABLED              0x10422
#define HID_CATEGORY_RADIO_DISABLED             0x10423
...
#define HIDD_TRACETOOL_DIALOG                   0x20066

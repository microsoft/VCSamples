 ...
 */
/* Compiler settings for AutoServer.idl:
...
#ifndef __AutoServer_h__
#define __AutoServer_h__
...
#ifndef __AutoServ_FWD_DEFINED__
#define __AutoServ_FWD_DEFINED__

#ifdef __cplusplus
typedef class AutoServ AutoServ;
#else
typedef struct AutoServ AutoServ;
#endif /* __cplusplus */

#endif 	/* __AutoServ_FWD_DEFINED__ */
...
EXTERN_C const IID IID_IAutoServ;
    ...
    MIDL_INTERFACE("A6D89F1B-35F4-11D2-9375-00C04FD9757C")
...
EXTERN_C const CLSID CLSID_AutoServ;

#ifdef __cplusplus

class DECLSPEC_UUID("A6D89F1C-35F4-11D2-9375-00C04FD9757C")
AutoServ;
#endif

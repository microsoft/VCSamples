========================================================================
    ACTIVE TEMPLATE LIBRARY : DispServer Project Overview
========================================================================

AppWizard has created this DispServer project for you to use as the starting point for
...
_DispServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_DispServer.h)
        GUID definitions                                (_DispServer_i.c)
        A type library                                  (_DispServer.tlb)
        Marshaling code                                 (_DispServer_p.c and dlldata.c)
DispServer.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named DispServer.pch and a precompiled types file named StdAfx.obj.
...
DispServerps.vcproj
	...
	dlldata.c, DispServer_i.c and DispServer_p.c which are required

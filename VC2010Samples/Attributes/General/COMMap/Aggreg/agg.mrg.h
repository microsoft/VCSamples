...
//
// c:\temp\vcsamples\vc2010samples\attributes\general\commap\aggreg\agg.mrg.h
...
#injected_line 19 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\agg.h"
    virtual HRESULT STDMETHODCALLTYPE IAgg::Invoke(
    ...
    virtual HRESULT STDMETHODCALLTYPE IAgg::GetIDsOfNames(
                /* [in] */ REFIID riid,
    ...
    virtual HRESULT STDMETHODCALLTYPE IAgg::GetTypeInfoCount(unsigned int*  pctinfo) 
    {
        if (pctinfo == NULL) {
            return E_POINTER;
        }
        CComPtr<ITypeInfo> spTypeInfo;
        *pctinfo = 
                       (SUCCEEDED(TypeInfoHelper(__uuidof(IAgg), 0, &spTypeInfo))) ? 1 : 0;
        return S_OK;
    }
    virtual HRESULT STDMETHODCALLTYPE IAgg::GetTypeInfo(unsigned int iTInfo, LCID lcid, ITypeInfo** ppTInfo) 
    {
        if (iTInfo != 0) {
            return DISP_E_BADINDEX;
        }
        return TypeInfoHelper(__uuidof(IAgg), lcid, ppTInfo);
    }
#injected_line 26 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\agg.h"
...
#injected_line 26 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\agg.h"
    static RGSStrings* GetOpcodeStringVals() 
    {
        static RGSStrings rgStrings[] = 
            ...
            {_T("%FriendlyName%"),1 }, 
            {_T("CLSID"),0 }, 
            {_T("{B27F2CE1-D1B9-42B3-9E4C-9E7CA7767043}"),0 }, 
            {_T("Aggreg.Agg"),0 }, 
            {_T("CurVer"),0 }, 
            {_T("ProgID"),0 }, 

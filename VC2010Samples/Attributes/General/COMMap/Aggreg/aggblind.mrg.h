...
//
// c:\temp\vcsamples\vc2010samples\attributes\general\commap\aggreg\aggblind.mrg.h
...
#injected_line 20 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\aggblind.h"
    virtual HRESULT STDMETHODCALLTYPE IAggBlind::Invoke(
    ...
    virtual HRESULT STDMETHODCALLTYPE IAggBlind::GetIDsOfNames(
                /* [in] */ REFIID riid,
    ...
    virtual HRESULT STDMETHODCALLTYPE IAggBlind::GetTypeInfoCount(unsigned int*  pctinfo) 
    {
        if (pctinfo == NULL) {
            return E_POINTER;
        }
        CComPtr<ITypeInfo> spTypeInfo;
        *pctinfo = 
                       (SUCCEEDED(TypeInfoHelper(__uuidof(IAggBlind), 0, &spTypeInfo))) ? 1 : 0;
        return S_OK;
    }
    virtual HRESULT STDMETHODCALLTYPE IAggBlind::GetTypeInfo(unsigned int iTInfo, LCID lcid, ITypeInfo** ppTInfo) 
    {
        if (iTInfo != 0) {
            return DISP_E_BADINDEX;
        }
        return TypeInfoHelper(__uuidof(IAggBlind), lcid, ppTInfo);
    }
#injected_line 27 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\aggblind.h"
...
#injected_line 27 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\aggblind.h"
    static RGSStrings* GetOpcodeStringVals() 
    {
        static RGSStrings rgStrings[] = 
            					{
            						{_T(""),0 }, 
            {_T("Aggreg.AggBlind.1"),0 }, 
            {_T("%FriendlyName%"),1 }, 
            {_T("CLSID"),0 }, 
            {_T("{A86DF044-ED8E-40AD-B00A-EAE3D6DE49AA}"),0 }, 
            {_T("Aggreg.Blind"),0 }, 
            {_T("CurVer"),0 }, 
            {_T("ProgID"),0 }, 
...
#injected_line 27 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\aggblind.h"
    ...
    {
        return _T("CAggBlind Object");
    }
#injected_line 27 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\aggblind.h"
    static const TCHAR* GetProgID() 
    {
        return _T("Aggreg.AggBlind.1");
    }
#injected_line 27 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\aggblind.h"
    static const TCHAR* GetVersionIndependentProgID() 
    {
        return _T("Aggreg.Blind");
    }
#injected_line 27 "c:\\temp\\vcsamples\\vc2010samples\\attributes\\general\\commap\\aggreg\\aggblind.h"

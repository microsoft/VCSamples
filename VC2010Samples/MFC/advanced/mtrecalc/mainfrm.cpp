...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
	...
	ON_MESSAGE(WM_USER_RECALC_IN_PROGRESS, OnRecalcInProgress)
END_MESSAGE_MAP()
...
LRESULT CMainFrame::OnRecalcInProgress(WPARAM wParam, LPARAM)
{
	m_nPercentDone = (int)wParam;
	CString strPercentDone;
	strPercentDone.Format("%i%c", m_nPercentDone, '%');

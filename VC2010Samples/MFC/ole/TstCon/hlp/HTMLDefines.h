...
#define HID_CLOSE                               0x103E9
#define HID_CLEAR                               0x103EA
#define HID_CANCEL_EDIT_CNTR                    0x18000
#define HID_EDIT_DELETE                         0x18003
#define HID_VIEW_NOTIFICATIONLOG                0x18006
#define HID_VIEW_EVENTLOG                       0x18007
#define HID_OPTIONS_FREEZEEVENTS                0x18008
#define HID_EDIT_INSERTCONTROL                  0x18009
#define HID_OPTIONS_USERMODE                    0x1800A
#define HID_OPTIONS_DESIGNMODE                  0x1800B
#define HID_EDIT_INVOKEMETHODS                  0x1800C
#define HID_EDIT_AMBIENTPROPERTIES              0x1800D
#define HID_EDIT_EMBEDDEDOBJECTFUNCTIONS_ACTIVATE	0x1800E
#define HID_EDIT_EMBEDDEDOBJECT_ACTIVATE        0x1800F
#define HID_OPTIONS_CONTAINERPROPERTIES         0x18010
#define HID_OPTIONS_CONTAINEROPTIONS            0x18011
#define HID_VIEW_CONTAINERINFO                  0x18012
#define HID_OBJECT_SAVETOSTREAM                 0x18013
#define HID_CONTROL_SAVETOSTREAM                0x18014
#define HID_EDIT_LOADOBJECTFROMSTREAM           0x18015
#define HID_EDIT_INSERTFROMSTREAM               0x18016
#define HID_FILE_SAVETOSTREAM                   0x18018
#define HID_FILE_LOADFROMSTREAM                 0x18019
#define HID_CONTROL_EVENTLOGGING                0x1801B
#define HID_CONTROL_SAVETOPROPERTYBAG           0x1801D
#define HID_OPTIONS_TRACELEVEL_NONE             0x18021
#define HID_OPTIONS_TRACELEVEL_NORMAL           0x18023
#define HID_OPTIONS_TRACELEVEL_VERBOSE          0x18025
#define HID_FILE_REGISTERCONTROLS               0x18026
#define HID_TWOPASSDRAWING                      0x18029
#define HID_SLOWDRAWING                         0x1802B
#define HID_OPTIONS_SLOWDRAWING                 0x1802C
#define HID_OPTIONS_TWOPASSDRAWING              0x1802D
#define HID_OPTIONS_LOGGING                     0x1802E
#define HID_CONTROL_INVOKEMETHODS               0x1802F
#define HID_CONTAINER_OPTIONS                   0x18030
#define HID_CONTAINER_AMBIENTPROPERTIES         0x18031
#define HID_CONTAINER_INFO                      0x18032
#define HID_EDIT_DELETEALL                      0x18033
#define HID_CONTAINER_TABORDER                  0x18035
#define HID_CONTROL_LOGGING                     0x18037
#define HID_CONTROL_SAVETOSUBSTORAGE            0x18038
#define HID_EDIT_INSERTCONTROLFROMSUBSTORAGE    0x18039
#define HID_VIEW_OUTPUT_WINDOW                  0x1803A
#define HID_CONTROL_ACTIVATE                    0x18040
#define HID_CONTROL_DEACTIVATE                  0x18041
#define HID_CONTROL_UIACTIVATE                  0x18042
#define HID_CONTROL_UIDEACTIVATE                0x18043
#define HID_EDIT_BRINGTOFRONT                   0x18044
#define HID_EDIT_SENDTOBACK                     0x18045
#define HID_EDIT_MULTISELPROPERTIES             0x18046
#define HID_TOOLS_RUNSCRIPT                     0x18047
#define HID_EDIT_SELECTALL                      0x18049
#define HID_TOOLS_OLEVIEW                       0x1804E
#define HID_TOOLS_REGEDIT                       0x1804F
#define HID_EDIT_PROPERTIES                     0x18050
#define HID_CONTROL_SAVETOSTORAGE               0x18052
#define HID_EDIT_INSERTCONTROLFROMSTORAGE       0x18053
#define HID_TOOLS_MACROS                        0x18055
#define HID_CONTROL_DRAWMETAFILE                0x18057
#define HID_RUNMACRO                            0x18058
#define HID_OUTPUTLOGEDIT_CLEAR                 0x18059
#define HID_OUTPUTLOGEDIT_COPY                  0x1805A
#define HID_OUTPUTLOGEDIT_HIDE                  0x1805B
#define HID_VIEW_MACROBAR                       0x1805C
...
// Resources (IDR_*) 
#define HIDR_TC98TYPE_CNTR_IP                   0x20006
#define HIDR_MAINFRAME                          0x20080
#define HIDR_TC98TYPE                           0x20081
#define HIDR_CONTAINER_CONTEXT                  0x20082
#define HIDR_CONTROL_CONTEXT                    0x20083
#define HIDR_OUTPUTLOGEDIT_CONTEXT              0x200A8
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_METHOD                             0x20086
#define HIDD_AMBIENTPROPERTIES                  0x20087
#define HIDD_CONTAINEROPTIONS_FEATURES          0x20088
#define HIDD_CONTAINEROPTIONS_INTERFACES        0x20089
#define HIDD_CONTAINERINFO                      0x2008A
#define HIDD_PROPERTYBAG                        0x2008C
#define HIDD_REGISTERCONTROLS                   0x2008E
#define HIDD_MACROBAR                           0x2008F
#define HIDD_LOGGING                            0x20091
#define HIDD_OUTPUTWINDOW                       0x20092
#define HIDD_TABORDER                           0x20093
#define HIDD_CONTROLLOGGING_EVENTS              0x20095
#define HIDD_CONTROLLOGGING_PROPERTYCHANGES     0x20096
#define HIDD_CONTROLLOGGING_PROPERTYEDITREQUESTS	0x20097
#define HIDD_INSERTCONTROL                      0x20098
#define HIDD_CATEGORIES                         0x20099
#define HIDD_NEWAMBIENTPROPERTY                 0x2009A
#define HIDD_OBJECTSAFETY                       0x2009B
#define HIDD_COMPONENTCATEGORIES                0x2009C
#define HIDD_CONTAINEROPTIONS_SERVICES          0x2009D
#define HIDD_MACRO                              0x2009F

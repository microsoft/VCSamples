...
void CPropSheetDemoDlg::OnPropSheet2()
{
	...
	CMyPropertySheet *pPropSheet = new CMyPropertySheet(CMFCPropertySheet::PropSheetLook_OutlookBar, IDB_ICONS_LARGE, 32);
...
void CPropSheetDemoDlg::OnPropSheet3()
{
	...
	CMyPropertySheet *pPropSheet = new CMyPropertySheet(CMFCPropertySheet::PropSheetLook_Tree, IDB_TREE_ICONS, 16);
...
void CPropSheetDemoDlg::OnPropSheet4()
{
	...
	CMyPropertySheet *pPropSheet = new CMyPropertySheet(CMFCPropertySheet::PropSheetLook_OneNoteTabs, IDB_ICONS_SMALL, 16);

	pPropSheet->GetTab().EnableAutoColor();
	pPropSheet->EnablePageHeader(m_bHeader ? HEADER_HEIGHT : 0);
	pPropSheet->DoModal();
...
void CPropSheetDemoDlg::OnPropSheet5()
{
	...
	CMyPropertySheet *pPropSheet  = new CMyPropertySheet(CMFCPropertySheet::PropSheetLook_List);

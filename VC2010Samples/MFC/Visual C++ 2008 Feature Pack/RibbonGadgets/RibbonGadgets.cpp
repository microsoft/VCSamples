...
BEGIN_MESSAGE_MAP(CRibbonGadgetsApp, CWinAppEx)
...
CRibbonGadgetsApp::CRibbonGadgetsApp()
{
...
CRibbonGadgetsApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CRibbonGadgetsApp initialization

BOOL CRibbonGadgetsApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CRibbonGadgetsDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CRibbonGadgetsView));
...
void CRibbonGadgetsApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
int CRibbonGadgetsApp::ExitInstance() 
{
	return CWinAppEx::ExitInstance();
}

void CRibbonGadgetsApp::PreLoadState ()
{

...
BEGIN_MESSAGE_MAP(COutlookDemoApp, CWinAppEx)
...
BOOL COutlookDemoApp::InitInstance()
{
	...
	// Enable user-defined tools. If you want allow more than 10 tools, // add tools entry to resources(ID_USER_TOOL11, ID_USER_TOOL12,...)
	...
	pDocTemplate = new CSingleDocTemplate(IDR_MAINFRAME, RUNTIME_CLASS(COutlookDemoDoc), RUNTIME_CLASS(CMainFrame),       // main SDI frame window
...
void COutlookDemoApp::PreLoadState()
{
...
void COutlookDemoApp::SetActiveFrame(OUTLOOK_FRAME frame)
{
...
void COutlookDemoApp::OnViewAppLook()
{

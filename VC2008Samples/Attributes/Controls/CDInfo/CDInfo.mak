...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W4 /GX /O1 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /Fp"$(INTDIR)\CDInfo.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=winmm.lib comctl32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\CDInfo.pdb" /machine:I386 /out:"$(OUTDIR)\CDInfo.dll" /implib:"$(OUTDIR)\CDInfo.lib" /idlout:_cdinfo.idl 
LINK32_OBJS= \
	"$(INTDIR)\CCDInfo.obj" \
	"$(INTDIR)\CDInfo.obj" \
	"$(INTDIR)\CDInfo1.obj" \
...
ALL : "$(OUTDIR)\CDInfo.dll" "$(OUTDIR)\CDInfo.bsc" ".\Debug\regsvr32.trg"
...
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W4 /Gm /GX /ZI /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\CDInfo.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=winmm.lib comctl32.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\CDInfo.pdb" /debug /machine:I386 /out:"$(OUTDIR)\CDInfo.dll" /implib:"$(OUTDIR)\CDInfo.lib" /idlout:_cdinfo.idl 
LINK32_OBJS= \
	"$(INTDIR)\CCDInfo.obj" \
	"$(INTDIR)\CDInfo.obj" \
	"$(INTDIR)\CDInfo1.obj" \
...
ALL : "$(OUTDIR)\CDInfo.dll" ".\ReleaseU\regsvr32.trg"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W4 /GX /O1 /D "NDEBUG" /D "_UNICODE" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /Fp"$(INTDIR)\CDInfo.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
ALL : "$(OUTDIR)\CDInfo.dll" ".\DebugU\regsvr32.trg"
...
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W4 /Gm /GX /ZI /Od /D "_DEBUG" /D "_UNICODE" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /Fp"$(INTDIR)\CDInfo.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(INTDIR)\CDInfo.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
...
CPP_SWITCHES=/nologo /MT /W4 /GX /O1 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /Fp"$(INTDIR)\CDInfo.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MTd /W4 /Gm /GX /ZI /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\CDInfo.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MT /W4 /GX /O1 /D "NDEBUG" /D "_UNICODE" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /Fp"$(INTDIR)\CDInfo.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MTd /W4 /Gm /GX /ZI /Od /D "_DEBUG" /D "_UNICODE" /D "WIN32" /D "_WINDOWS" /D "_WINDLL" /D "_MBCS" /D "_USRDLL" /D "_ATL_ATTRIBUTES" /Fp"$(INTDIR)\CDInfo.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 

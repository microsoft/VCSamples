...
SOURCE=.\FireWnd.cpp
"$(OUTDIR)\FireWnd.obj"	"$(OUTDIR)\$(PREHEADER)" : $(SOURCE) "$(OUTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
SOURCE=.\ATLFire.cpp
"$(OUTDIR)\ATLFire.obj" : $(SOURCE) "$(OUTDIR)" "$(OUTDIR)\$(PREHEADER)"
	$(CPP) @<<
   $(CPP_PROJ) $(SOURCE)
<<
...
"$(OUTDIR)\FireTabCtrl.obj" : $(SOURCE) "$(OUTDIR)" "$(OUTDIR)\$(PREHEADER)"
	$(CPP) @<<
   $(CPP_PROJ) $(SOURCE)
<<
...
SOURCE=.\PropDlg.cpp
"$(OUTDIR)\PropDlg.obj" : $(SOURCE) "$(OUTDIR)" "$(OUTDIR)\$(PREHEADER)"
	$(CPP) @<<
   $(CPP_PROJ) $(SOURCE)
<<

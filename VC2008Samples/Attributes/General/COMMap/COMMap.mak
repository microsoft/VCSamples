...
SOURCE=.\COMMap.cpp
"$(OUTDIR)\COMMap.obj"	"$(OUTDIR)\$(PREHEADER)" : $(SOURCE) "$(OUTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
SOURCE=.\Outer.cpp
"$(OUTDIR)\Outer.obj" : $(SOURCE) "$(OUTDIR)" "$(OUTDIR)\$(PREHEADER)"
	$(CPP) @<<
   $(CPP_PROJ) $(SOURCE)
<<
...
SOURCE=.\Chain.cpp
"$(OUTDIR)\Chain.obj" : $(SOURCE) "$(OUTDIR)" "$(OUTDIR)\$(PREHEADER)"
	$(CPP) @<<
   $(CPP_PROJ) $(SOURCE)
<<

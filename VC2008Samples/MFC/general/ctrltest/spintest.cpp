...
BOOL CSpinEditDlg::OnInitDialog()
{
	...
	for (int i = 0; i < NUM_EDIT; i++)
	{
		...
		// The default range for the spin button has the maximum set to zero (0) 
		// and the minimum set to 100. Since the maximum value is less than the
		// minimum value, clicking the up arrow will decrease the position and 
		// clicking the down arrow will increase it. 
		// Call SetRange32 to set it from 0 to 100

		pSpin->SetRange32(0,100);

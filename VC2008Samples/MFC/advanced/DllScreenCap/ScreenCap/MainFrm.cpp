...
#include "ScreenCap.h"
#include "MainFrm.h"
#pragma comment(lib, "DllScreenCap.lib")
...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	ON_WM_CREATE()
	ON_WM_SETFOCUS()
	ON_COMMAND(ID_FILE_CONFIGURESCREENCAPTURE, OnFileConfigureScreenCapture)
...
{
	memset(&m_CapData, 0, sizeof(CaptureData));
	m_CapData.bCaptureFullScreen = TRUE;
}
...
void CMainFrame::OnFileConfigureScreenCapture(void)
{
	ConfigureCapture(GetSafeHwnd(), &m_CapData);
}

void CMainFrame::OnFileScreencapture(void)
{
	...
	if (m_CapData.szCaptureFilename[0] != '\0') {
		...
		m_wndView.SetImage(strPathName);
	}
}

...
namespace AccountPictureName
{
    ...
    partial ref class GetAccountPicture : public ::AccountPictureName::Common::LayoutAwarePage, 
    ...
    private:
        ...
        private: ::Windows::UI::Xaml::Controls::Image^ AccountPictureImage;
        private: ::Windows::UI::Xaml::Controls::MediaElement^ AccountPictureVideo;
        private: ::Windows::UI::Xaml::Controls::TextBlock^ InputTextBlock1;
        private: ::Windows::UI::Xaml::Controls::Button^ GetSmallImageButton;
        private: ::Windows::UI::Xaml::Controls::Button^ GetLargeImageButton;
        private: ::Windows::UI::Xaml::Controls::Button^ GetVideoButton;

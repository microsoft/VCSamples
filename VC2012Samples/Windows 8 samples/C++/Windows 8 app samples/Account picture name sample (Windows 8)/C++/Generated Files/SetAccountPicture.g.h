...
namespace AccountPictureName
{
    ...
    partial ref class SetAccountPicture : public ::AccountPictureName::Common::LayoutAwarePage, 
    ...
    private:
        ...
        private: ::Windows::UI::Xaml::Controls::Button^ SetImageButton;
        private: ::Windows::UI::Xaml::Controls::Button^ SetVideoButton;

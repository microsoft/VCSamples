...
namespace AccountPictureName
{
    ...
    partial ref class GetUserFirstAndLastName : public ::AccountPictureName::Common::LayoutAwarePage, 
    ...
    private:
        ...
        private: ::Windows::UI::Xaml::Controls::Button^ GetFirstNameButton;
        private: ::Windows::UI::Xaml::Controls::Button^ GetLastNameButton;

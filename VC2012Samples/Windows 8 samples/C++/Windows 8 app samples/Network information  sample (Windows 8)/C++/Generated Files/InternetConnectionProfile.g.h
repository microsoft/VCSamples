...
namespace SDKSample
{
    namespace NetworkInformationApi
    {
        ...
        partial ref class InternetConnectionProfile : public ::Windows::UI::Xaml::Controls::Page, 
        ...
        private:
            ...
            private: ::Windows::UI::Xaml::Controls::TextBlock^ Scenario1Input;
            private: ::Windows::UI::Xaml::Controls::Button^ InternetConnectionProfileButton;
        };
    }
}

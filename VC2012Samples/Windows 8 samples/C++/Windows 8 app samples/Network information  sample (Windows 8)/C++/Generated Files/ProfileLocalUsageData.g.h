...
namespace SDKSample
{
    namespace NetworkInformationApi
    {
        ...
        partial ref class ProfileLocalUsageData : public ::Windows::UI::Xaml::Controls::Page, 
        ...
        private:
            ...
            private: ::Windows::UI::Xaml::Controls::TextBlock^ Scenario2Input;
            private: ::Windows::UI::Xaml::Controls::Button^ ProfileLocalUsageDataButton;
        };
    }
}

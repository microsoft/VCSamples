...
namespace SDKSample
{
    namespace NetworkInformationApi
    {
        ...
        partial ref class NetworkStatusChange : public ::Windows::UI::Xaml::Controls::Page, 
        ...
        private:
            ...
            private: ::Windows::UI::Xaml::Controls::TextBlock^ Scenario5Input;
            private: ::Windows::UI::Xaml::Controls::Button^ NetworkStatusChangeButton;
        };
    }
}
